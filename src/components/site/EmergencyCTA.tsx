  ...
  return (
    <section className="mx-auto max-w-7xl px-4 sm:px-6 py-16">
      <div className="relative overflow-hidden rounded-3xl border border-primary/40 bg-gradient-to-br from-primary/20 via-card to-card p-8 md:p-14 text-center">
        ...
        <h2 className="mt-3 text-3xl md:text-5xl font-black">Stuck on the road? D &amp; L Recovery is on the way.</h2>
        <p className="mx-auto mt-4 max-w-2xl text-muted-foreground">Fast, reliable roadside assistance across Bristol and surrounding areas. Call now or message us on WhatsApp — help is on the way.</p>
